...
const Dropdown = ({ toggleContent = '', toggleButtonDefaultStyle = true, hasIcon = true, children }) => {
    return (
...
const DropdownItem = ({ href = '#', icon = '', text = '', handleClick }) => {
    return <Menu.Item>
        <Link href={href} className="text-gray-700 block px-4 py-2 text-sm hover:bg-gray-100 hover:!brightness-100" onClick={(e) => { handleClick && handleClick(e) }}>
